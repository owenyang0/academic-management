...
<!--数据输入-->
<form name="add_teacher_form" action="teacherman.jsp" method="post"
...
<table border="1" width="100%" cellspacing="0" cellpadding="0" bordercolor="#808080"
	bordercolorlight="#808080" bordercolordark="#808080">
<jsp:useBean id="teacher_select" class="teachlessionman.teacher_operation" scope="page"/>
<%
...
<tr>
	...
	<td align="center">
		<a href='teacher_update1.jsp?teacher_id=<%=rs.getInt("teacher_id")%>&lession_id=<%=rs.getString("lession_name") %>'>修改</a>
	</td>
	<td align="center">
		<a href="teacher_delete.jsp?student_id=<%=rs.getInt("teacher_id") %>"
